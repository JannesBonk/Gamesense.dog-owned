...
#include "c_chathud.hpp"
#include "physics.hpp"
#include "iv_render_beams.hpp"
#include "networkstringtablecontainer.h"
namespace interfaces {
	...
	inline NetworkStringTableContainer* networkStringTableContainer;
	...
	inline c_hudchat* chat;
	inline i_physics_surface_props* surface_props;
	inline HWND game_hwnd;
	extern i_view_render_beams* render_beams;
	inline void(__stdcall* restoreEntityToPredictedFrame)(int, int);
	bool initialize();
}
