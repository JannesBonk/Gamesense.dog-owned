...
public:
	...
	// void draw_grenades_name(player_t* m_entity, const Box& box);
	void draw_weapon_icon(player_t* m_entity, const Box& box, bool space);
	void draw_weapon_text(player_t* m_entity, const Box& box, bool space);
	void draw_flags(player_t* e, const Box& box);
	void draw_health_gradient(player_t* m_entity, const Box& box, const HPInfo& hpbox);
