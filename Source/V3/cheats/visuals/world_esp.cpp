...
void worldesp::molotov_timer(entity_t* entity)
{
	...
	render::get().circle_filled(screen_origin.x, screen_origin.y - size.y * 0.8f, 60, 32, Color(15, 15, 15, 255));
	...
	render::get().CircularProgressBar(screen_origin.x, screen_origin.y - size.y * 0.8f, 32, -20, (360 * factor), 2.5f, Color(255, 255, 255, 144));
