...
namespace IdaLovesMe {
	...
	namespace ui {
		...
		bool ListBoxSelectableSkins(const char* label, bool activated, const Vec2& size_arg);
		...
		bool CheckboxBold(const char* label, bool* selected);
		bool CheckboxOrange(const char* label, bool* selected);
		...
		bool LabelNew(const char* label);
