...
void worldesp::molotov_timer(entity_t* entity)
{
	...
	render::get().circle_filled(screen_origin.x, screen_origin.y - size.y * 0.2f, 85, 20, Color(200, 25, 25, 500));
	render::get().CircularProgressBar(screen_origin.x, screen_origin.y - size.y * 0.8f, 28, -20, (360 * factor), 2.5f, Color(255, 255, 255, 144));
	render::get().circle_filled(screen_origin.x, screen_origin.y - size.y * 0.5f, 85, 32, Color(0, 0, 0));


	render::get().text(fonts[GRENADES], screen_origin.x + 1.0f, screen_origin.y - size.y * 0.5f - 6.0f, Color(255, 255, 0), HFONT_CENTERED_X | HFONT_CENTERED_Y, "l");
