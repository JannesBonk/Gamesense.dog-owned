	...
	if (type && path.size() > 1)
	{
		...
		for (auto it = path.begin(); it != path.end(); ++it)
		{
			if (math::world_to_screen(prev, nadeStart) && math::world_to_screen(*it, nadeEnd))
				if (hastarget)
					render::get().line((int)nadeStart.x, (int)nadeStart.y, (int)nadeEnd.x, (int)nadeEnd.y, Color(c_config::get()->c["grenade_hitcolor"][0], c_config::get()->c["grenade_hitcolor"][1], c_config::get()->c["grenade_hitcolor"][2], c_config::get()->c["grenade_hitcolor"][3]));
				if (!hastarget)
					render::get().line((int)nadeStart.x, (int)nadeStart.y, (int)nadeEnd.x, (int)nadeEnd.y, Color(c_config::get()->c["grentrajcoll"][0], c_config::get()->c["grentrajcoll"][1], c_config::get()->c["grentrajcoll"][2], c_config::get()->c["grentrajcoll"][3]));
		...
		*/
		...
		if (hastarget)
		{
			render::get().Draw3DCircleGradient(endpos, 33, Color(c_config::get()->c["grenade_hitcolor"][0], c_config::get()->c["grenade_hitcolor"][1], c_config::get()->c["grenade_hitcolor"][2], c_config::get()->c["grenade_hitcolor"][3]), alpha);
		}
		if (!hastarget)
		{
			render::get().Draw3DCircleGradient(endpos, 33, Color(c_config::get()->c["grentrajcoll"][0], c_config::get()->c["grentrajcoll"][1], c_config::get()->c["grentrajcoll"][2], c_config::get()->c["grentrajcoll"][3]), alpha);
		}
		/*
