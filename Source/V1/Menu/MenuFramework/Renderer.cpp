...
void CDraw::CreateObjects()
{
    ...
    D3DXCreateFontA(m_Device, 96, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, DRAFT_QUALITY, DEFAULT_PITCH, "gamsens", &Fonts::TabIcons4);

    this->m_LBFont = AddFontMemResourceEx((void*)(RawData::LBIcon), (DWORD)/*5192*/10384, nullptr, &nFonts2);
    ...
    D3DXCreateFontA(m_Device, 12, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_NATURAL_QUALITY, DEFAULT_PITCH, "Lucida console", &Fonts::Logs);
    D3DXCreateFontA(m_Device, 28, 0, 600, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH, "Calibri", &Fonts::Indicator);
    // Dpi Fonts
    ...
    D3DXCreateFontA(m_Device, 9, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_NATURAL_QUALITY, FIXED_PITCH, "Verdana", &Fonts::Keybind25);
    D3DXCreateFontA(m_Device, 11, 0, 0, 0, 0, ANSI_CHARSET, OUT_DEFAULT_PRECIS, CLEARTYPE_NATURAL_QUALITY, FIXED_PITCH, "Verdana", &Fonts::Keybind50);
