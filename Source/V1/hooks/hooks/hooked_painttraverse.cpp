...
void __fastcall hooks::hooked_painttraverse(void* ecx, void* edx, vgui::VPANEL panel, bool force_repaint, bool allow_force)
{
	...
	if (reload_fonts())
	{
		...
		fonts[NAME] = create_font(crypt_str("Railway"), 12 * CMenu::get()->GetDPINum(), FW_LIGHT, FONTFLAG_ANTIALIAS);
		/*
		fonts[NAME] = create_font(crypt_str("Verdana"), 12 * CMenu::get()->GetDPINum(), FW_LIGHT, FONTFLAG_ANTIALIAS);
		*/
