...
void Discord::Update()
{
    ...
    discordPresence.details = "Playing With Gamesense.Dogshit";
    discordPresence.state = "Get Good Get PassatHook V3";
   ...
   // discordPresence.startTimestamp = elapsed;
    ...
    discordPresence.button2_url = "https://discord.gg/TGaSe52hJQ";
